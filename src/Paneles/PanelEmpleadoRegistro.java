...
public class PanelEmpleadoRegistro extends javax.swing.JPanel {
    ...
    public PanelEmpleadoRegistro() {
        initComponents();
    }
    
    public PanelEmpleadoRegistro(javax.swing.JFrame Frame,Connection con,Usuario usu) {
        initComponents();
        this.con = con;
        this.Frame = Frame;
        this.usu = usu;
    ...
    private void BotonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonGuardarActionPerformed
        if(EvaluarContenido()==false){
            ...
            conexion.AltaEmpleado(con,Nombres.getText(),Apellidos.getText(),Dire.getText(),Tel.getText(),(String) Puesto.getSelectedItem(),CURP.getText(),getSexo(),getDate());
            ResetContenido();
