...
public class PanelClienteRegistro extends javax.swing.JPanel {
    ...
    public PanelClienteRegistro() {
        initComponents();
        this.SetComboEmpleado();
    }
    
    public PanelClienteRegistro(Connection con) {
        initComponents();
        this.con = con;
        this.SetComboEmpleado(); 
    }
    
    public PanelClienteRegistro(javax.swing.JFrame Frame,Connection con,Usuario usu) {
        initComponents();
        this.con = con;
        this.SetComboEmpleado();
        this.Frame = Frame;
    ...
    private void BotonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonGuardarActionPerformed
        ...
        if(EvaluarContenido()==false){
            ...
            lblContact.setForeground(new java.awt.Color(51,51,51));
            ResetConetenido();
            PU.Exito(Frame, "Cliente Guardado");
            }
            else{
