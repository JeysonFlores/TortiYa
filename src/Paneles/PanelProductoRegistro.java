...
public class PanelProductoRegistro extends javax.swing.JPanel {
    ...
    public PanelProductoRegistro() {
        initComponents();
    }
    
    public PanelProductoRegistro(javax.swing.JFrame Frame,Connection con,Usuario usu) {
        initComponents();
        this.con = con;
        this.Frame = Frame;
        this.usu = usu;
