...
public class PanelProductoConsulta extends javax.swing.JPanel {
    ...
    public PanelProductoConsulta(Connection con) {
        initComponents();
        this.con = con;
        setTabla();
    }
    
    public PanelProductoConsulta(javax.swing.JFrame Frame,Connection con,Usuario usu) {
        initComponents();
        this.con = con;
        setTabla();
        this.Frame = Frame;
    ...
    public void setTabla(){
        ...
        model = Conexion.ActualizarProductos(con,TxtBusqueda.getText(), RadioElm.isSelected());
    ...
    private void initComponents() {
        ...
        TxtBusqueda.setPlaceholder("Ingrese nombre de producto");
    ...
    private void BotonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonBuscarActionPerformed
        DefaultTableModel model = new DefaultTableModel();
        model = Conexion.BuscarProductos(con,TxtBusqueda.getText(), RadioElm.isSelected());
        Tabla.setModel(model);
    ...
    private void BotonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonEliminarActionPerformed
        if(usu.getPuesto().equals("Gerente")){
            if(Tabla.getSelectedRow()!=-1){
                if(Conexion.ProductoOcupado(con,Tabla.getValueAt(Tabla.getSelectedRow(),0).toString())==0){
                    if(PU.PopPreg(Frame, "¿Quieres eliminar el producto "+Tabla.getValueAt(Tabla.getSelectedRow(),1)+"?")==1){
                        Conexion.BajaProducto(con, (String) Tabla.getValueAt(Tabla.getSelectedRow(), 0));
                        setTabla();
                    ...
                    PU.Error(Frame, "Producto Ocupado");
                }
                }
            else{
    ...
    private void BotonReactivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonReactivarActionPerformed
        if(usu.getPuesto().equals("Gerente")){
            if(Tabla.getSelectedRow()!=-1){
                if(PU.PopPreg(Frame, "¿Quieres reactivar el producto "+Tabla.getValueAt(Tabla.getSelectedRow(),1)+"?")==1){
                    Conexion.ReactivarProducto(con, (String) Tabla.getValueAt(Tabla.getSelectedRow(), 0));
                    setTabla();
    ...
    private void rSButtonHover2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonHover2ActionPerformed
        if(usu.getPuesto().equals("Gerente")){
            PanelProductoRegistro PER = new PanelProductoRegistro(Frame,con,usu);
    ...
    private void BotonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonEditarActionPerformed
        if(usu.getPuesto().equals("Gerente")){
            if(Tabla.getSelectedRow()!=-1){
                if(PU.PopPreg(Frame, "¿Quieres editar el producto "+Tabla.getValueAt(Tabla.getSelectedRow(),1)+"?")==1){
                    PanelProductoEdicion PEE = new PanelProductoEdicion(Frame,con,(String) Tabla.getValueAt(Tabla.getSelectedRow(), 0),(String) Tabla.getValueAt(Tabla.getSelectedRow(), 1),(String) Tabla.getValueAt(Tabla.getSelectedRow(), 2),(String) Tabla.getValueAt(Tabla.getSelectedRow(), 3),(String) Tabla.getValueAt(Tabla.getSelectedRow(), 4),usu);
                    this.setLayout(new java.awt.BorderLayout());
                    this.removeAll();
                    this.add(PEE);
                    this.revalidate();
