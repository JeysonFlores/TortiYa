...
public class PanelPuntoDeVenta extends javax.swing.JPanel {
    ...
    public PanelPuntoDeVenta(javax.swing.JFrame Frame,Connection con,Usuario usuario) {
        initComponents();
        TablaP.setModel(conexion.getPŕoductos(con));
        this.Frame = Frame;
        this.con = con;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 270, 280));
        ...
        jPanel1.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 50, 320, 280));

        Unidad.setPlaceholder("Ingrese");
        ...
        jPanel1.add(BotonGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 370, 150, 40));
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 340, 50, 40));
        ...
        jPanel1.add(Total, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 340, 60, 40));
        ...
        jPanel1.add(Total1, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 340, 30, 40));
    ...
    private void BotonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonGuardarActionPerformed
        if(EvaluarContenido()==false){
            if(PU.PopPreg(Frame, "¿Quiere realizar la venta?")==1){
                conexion.RealizarVenta(con, TablaD, usuario.getClave(), getDateNowParsed(), Total.getText());
                setTableVoid();
                PU.Cambio(Frame, Total.getText());
                Total.setText("0.0");
            }
            else{
