...
public class PanelClienteConsulta extends javax.swing.JPanel {
    ...
    public PanelClienteConsulta(Connection con) {
        initComponents();
        this.con = con;
        setTabla();
    }
    
    public PanelClienteConsulta(javax.swing.JFrame Frame,Connection con,Usuario usu) {
        initComponents();
        this.con = con;
        setTabla();
        this.Frame = Frame;
    ...
    public void setTabla(){
        ...
        model = Conexion.ActualizarClientes(con,TxtBusqueda.getText(), RadioElm.isSelected());
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(255, 199, 125));
        ...
        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 450, 780, 30));
        ...
        rSButtonHover2.setBackground(new java.awt.Color(27, 34, 36));
        rSButtonHover2.setBorder(null);
        rSButtonHover2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/PlusSquare25.png"))); // NOI18N
        rSButtonHover2.setText("  Agregar");
        rSButtonHover2.setColorHover(new java.awt.Color(20, 26, 27));
        rSButtonHover2.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        rSButtonHover2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rSButtonHover2ActionPerformed(evt);
            }
        });
        Contenido.add(rSButtonHover2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 360, 130, -1));
        ...
        TxtBusqueda.setPlaceholder("Ingrese el nombre del cliente");
    ...
    private void BotonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonBuscarActionPerformed
        DefaultTableModel model = new DefaultTableModel();
        model = Conexion.BuscarClientes(con,TxtBusqueda.getText(), RadioElm.isSelected());
        Tabla.setModel(model);
    ...
    private void BotonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonEliminarActionPerformed
        if(usu.getPuesto().equals("Gerente")){
            if(Tabla.getSelectedRow()!=-1){
                if(PU.PopPreg(Frame, "¿Quieres eliminar el cliente "+Tabla.getValueAt(Tabla.getSelectedRow(),1)+"?")==1){
                    Conexion.BajaCliente(con, (String) Tabla.getValueAt(Tabla.getSelectedRow(), 0));
                    setTabla();
    ...
    private void rSButtonHover2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonHover2ActionPerformed
        if(usu.getPuesto().equals("Gerente")){
            PanelClienteRegistro PCR = new PanelClienteRegistro(Frame,con,usu);
    ...
    private void BotonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonEditarActionPerformed
        if(usu.getPuesto().equals("Gerente")){
            if(Tabla.getSelectedRow()!=-1){
                if(PU.PopPreg(Frame, "¿Quieres editar el cliente "+Tabla.getValueAt(Tabla.getSelectedRow(),1)+"?")==1){
                    PanelClienteEdicion PCE = new PanelClienteEdicion(Frame,con, (String) Tabla.getValueAt(Tabla.getSelectedRow(), 0),(String) Tabla.getValueAt(Tabla.getSelectedRow(), 1),(String) Tabla.getValueAt(Tabla.getSelectedRow(), 2),(String) Tabla.getValueAt(Tabla.getSelectedRow(), 3),(String) Tabla.getValueAt(Tabla.getSelectedRow(), 4),usu);
                    this.setLayout(new java.awt.BorderLayout());
                    this.removeAll();
                    this.add(PCE);
                    this.revalidate();
    ...
    private void BotonReactivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonReactivarActionPerformed
        if(usu.getPuesto().equals("Gerente")){
            if(Tabla.getSelectedRow()!=-1){
                if(PU.PopPreg(Frame, "¿Quieres reactivar el cliente "+Tabla.getValueAt(Tabla.getSelectedRow(),1)+"?")==1){
                    Conexion.ReactivarCliente(con, (String) Tabla.getValueAt(Tabla.getSelectedRow(), 0));
                    setTabla();
