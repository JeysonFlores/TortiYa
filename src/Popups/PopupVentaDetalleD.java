...
public class PopupVentaDetalleD extends javax.swing.JDialog {

    public PopupVentaDetalleD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public PopupVentaDetalleD(java.awt.Frame parent, boolean modal,Conexion conexion,Connection con,String idven,String Fecha,String Clien,String Empl,String tot) {
        super(parent, modal);
        initComponents();
        ...
        Total.setText(tot);
        TablaD.setModel(conexion.getVentaDetalles(con, idven));
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupVentaDetalleD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PopupVentaDetalleD dialog = new PopupVentaDetalleD(new javax.swing.JFrame(), true);
